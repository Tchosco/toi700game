...
export default function InfrastructureNationalPage() {
  const { user } = useAuth();
    ...
    <Layout>
      <div className="container mx-auto px-4 py-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold">Infraestrutura Nacional</h1>
            <p className="text-muted-foreground">Construa infraestruturas que afetam todo o Estado</p>
          </div>
        </div>
